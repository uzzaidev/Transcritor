...
Status geral: `92% pronto localmente`
...
- [ ] `.env` raiz completo. BLOQUEADO: faltam variaveis de entrada IMAP, destinatarios e banco.
...
- [ ] E2E real `IMAP -> Gemini -> ATA -> SMTP -> Neon`. BLOQUEADO: faltam IMAP, recipients e Neon.
...
- [ ] `ata_agent` rodando com e-mail real (`run-once` ou `daemon`). BLOQUEADO: faltam credenciais IMAP e destinatarios aprovados.
...
- [ ] Primeiro envio real a partir de e-mail de entrada validado. BLOQUEADO: falta IMAP e politica de envio.
