...
# -*- coding: utf-8 -*-
"""
Script para transcrever os 2 arquivos de áudio sobre impostos
Transcreve: Impostos 1.m4a, Impostos2.m4a
    ...
    try:
        ...
        if resultado and resultado.get('text'):
            ...
            with open(arquivo_saida, 'w', encoding='utf-8') as f:
                f.write(f"🎵 TRANSCRIÇÃO - IMPOSTOS\n")
                f.write(f"=" * 80 + "\n")
...
def main():
    """
    Função principal para transcrição dos 2 arquivos sobre impostos
    """
    print("🎯 TRANSCRITOR DE ÁUDIOS - IMPOSTOS")
    print("=" * 80)
    ...
    if transcricoes:
        ...
        arquivo_consolidado = os.path.join(pasta_atual, f"impostos_completo_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
        
        with open(arquivo_consolidado, 'w', encoding='utf-8') as f:
            f.write("💰 IMPOSTOS - TRANSCRIÇÕES COMPLETAS\n")
            f.write("=" * 80 + "\n")
