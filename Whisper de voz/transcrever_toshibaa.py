...
# -*- coding: utf-8 -*-
"""
Script para transcrever áudios do Toshiba (WhatsApp OGG)
Transcreve arquivos específicos da pasta 'toshibaa'
"""
...
ARQUIVOS = [
    "toshibaa/WhatsApp Ptt 2026-02-03 at 22.04.36.ogg",
    "toshibaa/WhatsApp Ptt 2026-02-03 at 22.06.56.ogg",
    "toshibaa/WhatsApp Ptt 2026-02-03 at 22.08.05.ogg",
    "toshibaa/WhatsApp Ptt 2026-02-03 at 22.10.49.ogg"
]
    ...
    try:
        ...
        if resultado and resultado.get('text'):
            ...
            with open(arquivo_saida, 'w', encoding='utf-8') as f:
                f.write(f"🎵 TRANSCRIÇÃO - TOSHIBA AUDIO\n")
                f.write(f"=" * 80 + "\n")
...
def main():
    ...
    Função principal
    """
    print("🎯 TRANSCRITOR DE ÁUDIOS TOSHIBA")
    print("=" * 80)
    ...
    # Obter o diretório do script (onde deve ser a raiz relativa para os arquivos)
    ...
    for arquivo in ARQUIVOS:
        ...
        if os.path.exists(caminho_completo):
            ...
            # Tentar verificar se o script está rodando de um nível acima ou algo assim,
            # mas vamos assumir que está na pasta raiz correta.
    ...
    if transcricoes:
        ...
        arquivo_consolidado = os.path.join(pasta_atual, f"toshiba_transcricoes_completo_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
        
        with open(arquivo_consolidado, 'w', encoding='utf-8') as f:
            f.write("📅 TOSHIBA ÁUDIOS - TRANSCRIÇÕES COMPLETAS\n")
            f.write("=" * 80 + "\n")
