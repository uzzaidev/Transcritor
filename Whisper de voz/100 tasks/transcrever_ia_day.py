...
# -*- coding: utf-8 -*-
"""
Script para transcrever reuniões do IA DAY
Transcreve 7 arquivos .m4a específicos
...
# Lista dos 7 arquivos específicos na ordem
ARQUIVOS = [
    "11111.m4a",
    "3333333.m4a",
    "22222222.m4a",
    ...
    try:
        ...
        if resultado and resultado.get('text'):
            ...
            with open(arquivo_saida, 'w', encoding='utf-8') as f:
                f.write(f"🎵 TRANSCRIÇÃO DE REUNIÃO - IA DAY\n")
                f.write(f"=" * 80 + "\n")
...
def main():
    """
    Função principal para transcrição das reuniões do IA DAY
    """
    print("🎯 TRANSCRITOR DE REUNIÕES - IA DAY")
    print("=" * 80)
    ...
    if transcricoes:
        ...
        arquivo_consolidado = os.path.join(pasta_atual, f"ia_day_completo_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
        
        with open(arquivo_consolidado, 'w', encoding='utf-8') as f:
            f.write("💬 REUNIÕES IA DAY - TRANSCRIÇÕES COMPLETAS\n")
            f.write("=" * 80 + "\n")
