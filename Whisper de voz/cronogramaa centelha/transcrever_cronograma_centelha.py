...
# -*- coding: utf-8 -*-
"""
Script para transcrever os 2 arquivos de áudio do cronograma Centelha
Transcreve: audio 1 cornograma.m4a, audio 2 cronograma.m4a
...
# Lista dos 2 arquivos específicos na ordem
ARQUIVOS = [
    "audio 1 cornograma.m4a",
    "audio 2 cronograma.m4a"
]
    ...
    try:
        ...
        if resultado and resultado.get('text'):
            ...
            with open(arquivo_saida, 'w', encoding='utf-8') as f:
                f.write(f"🎵 TRANSCRIÇÃO - CRONOGRAMA CENTELHA\n")
                f.write(f"=" * 80 + "\n")
...
def main():
    """
    Função principal para transcrição dos 2 arquivos de cronograma Centelha
    """
    print("🎯 TRANSCRITOR DE ÁUDIOS - CRONOGRAMA CENTELHA")
    print("=" * 80)
    ...
    if transcricoes:
        ...
        arquivo_consolidado = os.path.join(pasta_atual, f"cronograma_centelha_completo_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
        
        with open(arquivo_consolidado, 'w', encoding='utf-8') as f:
            f.write("🌟 CRONOGRAMA CENTELHA - TRANSCRIÇÕES COMPLETAS\n")
            f.write("=" * 80 + "\n")
