...
# -*- coding: utf-8 -*-
"""
Script para transcrever os 4 arquivos de chatbot específicos
Transcreve: 1chatbot.mp3, 2chatbot.mp3, 3chatbot.mp3, 4chatbot.mp3
...
def main():
    """
    Função principal para transcrição dos 4 arquivos de chatbot
    """
    print("🎯 TRANSCRITOR DE CONVERSAS CHATBOT")
    print("=" * 80)
    ...
    if transcricoes:
        ...
        arquivo_consolidado = os.path.join(pasta_atual, f"chatbot_completo_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
        
        with open(arquivo_consolidado, 'w', encoding='utf-8') as f:
            f.write("💬 CONVERSAS CHATBOT - TRANSCRIÇÕES COMPLETAS\n")
            f.write("=" * 80 + "\n")
