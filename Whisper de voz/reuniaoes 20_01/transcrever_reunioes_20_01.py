...
# -*- coding: utf-8 -*-
"""
Script para transcrever as 2 reuniões de 20/01/2026
Transcreve: sedetec.m4a, Telles.m4a
...
# Lista dos 2 arquivos específicos
ARQUIVOS = [
    "sedetec.m4a",
    "Telles.m4a"
]
    ...
    try:
        ...
        if resultado and resultado.get('text'):
            ...
            with open(arquivo_saida, 'w', encoding='utf-8') as f:
                f.write(f"🎵 TRANSCRIÇÃO - REUNIÕES 20/01/2026\n")
                f.write(f"=" * 80 + "\n")
...
def main():
    """
    Função principal para transcrição das 2 reuniões de 20/01/2026
    """
    print("🎯 TRANSCRITOR DE REUNIÕES - 20/01/2026")
    print("=" * 80)
    ...
    if transcricoes:
        ...
        arquivo_consolidado = os.path.join(pasta_atual, f"reunioes_20_01_completo_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
        
        with open(arquivo_consolidado, 'w', encoding='utf-8') as f:
            f.write("📅 REUNIÕES 20/01/2026 - TRANSCRIÇÕES COMPLETAS\n")
            f.write("=" * 80 + "\n")
