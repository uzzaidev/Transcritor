...
# -*- coding: utf-8 -*-
"""
Script para transcrever o arquivo de reuniao pranayama 1
Transcreve: reuniao pranayama 1.m4a
...
ARQUIVO = "reuniao pranayama 1.m4a"
    ...
    try:
        ...
        if resultado and resultado.get('text'):
            ...
            with open(arquivo_saida, 'w', encoding='utf-8') as f:
                f.write(f"🎵 TRANSCRIÇÃO - REUNIAO PRANAYAMA\n")
                f.write(f"{'='*80}\n")
...
def main():
    """
    Função principal para transcrição da reunião Pranayama
    """
    print("🎯 TRANSCRITOR - REUNIAO PRANAYAMA 1")
    print("=" * 80)
